...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e(
        ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).Tweakpane =
          {})
      );
})(this, function (t) {
  "use strict";
  ...
  class p {
    constructor(t) {
      var e;
      (this.message =
        null !== (e = l[t.type](t.context)) && void 0 !== e
          ? e
          : "Unexpected error"),
  ...
  const M = { optional: L(!0), required: L(!1) };
  function S(t, e) {
    const n = M.required.object(e)(t);
    return n.succeeded ? n.value : void 0;
  }
  const A = v(""),
    D = { veryfirst: "vfst", first: "fst", last: "lst", verylast: "vlst" };
  class j {
    constructor(t) {
      (this.parent_ = null),
        (this.blade = t.blade),
      ...
      this.blade.value("positions").emitter.on("change", () => {
        ["veryfirst", "first", "last", "verylast"].forEach((t) => {
          e.classList.remove(A(void 0, D[t]));
        }),
          this.blade.get("positions").forEach((t) => {
            e.classList.add(A(void 0, D[t]));
          });
      }),
  ...
  function N(t, e) {
    const n = t.createElementNS(R, "svg");
    return (n.innerHTML = I[e]), n;
  }
  function B(t, e, n) {
    ...
    constructor(t, e) {
      ...
      super(
        Object.assign(Object.assign({}, e), {
          view: new $(t, { props: e.props, viewProps: n }),
          viewProps: n,
        })
      ),
        (this.props = e.props),
  ...
  const G = {
    ...
    controller: (t) =>
      new q(t.document, {
        blade: t.blade,
        props: E.fromObject({ label: t.params.label }),
        valueController: new C(t.document, {
          props: E.fromObject({ title: t.params.title }),
          viewProps: t.viewProps,
        }),
      }),
    api: (t) =>
      t.controller instanceof q && t.controller.valueController instanceof C
        ? new c(t.controller)
        : null,
  };
  class Y extends j {
  ...
  function X() {
    return new E({ positions: k([], { equals: a }) });
  }
  class Q extends E {
    constructor(t) {
      super(t);
  ...
  class it extends e {
    ...
    onBindingUpdate_(t) {
      ...
      this.emitter_.emit("update", {
        event: new s(this, e, this.controller_.binding.target.presetKey),
      });
    }
  }
  class st extends q {
  ...
  class lt extends e {
    ...
    addSeparator(t) {
      return (function (t, e) {
        const n = e || {};
        return t.addBlade(
          Object.assign(Object.assign({}, n), { view: "separator" })
        );
      })(this, t);
    }
    addTab(t) {
    ...
    setUpApi_(t) {
      this.apiSet_.find((e) => e.controller_ === t) ||
        this.apiSet_.add(this.pool_.createBladeApi(t));
    }
    onRackAdd_(t) {
    ...
    onRackInputChange_(t) {
      ...
      if (e instanceof nt) {
        const n = rt(this.apiSet_, e),
          s = e.binding;
        this.emitter_.emit("change", {
          event: new i(n, s.target.read(), s.target.presetKey, t.options.last),
        });
      } else if (e instanceof Y) {
        const n = rt(this.apiSet_, e);
        this.emitter_.emit("change", {
          event: new i(n, e.value.rawValue, void 0, t.options.last),
        });
      }
    }
    onRackMonitorUpdate_(t) {
      ...
      this.emitter_.emit("update", {
        event: new s(e, n.target.read(), n.target.presetKey),
      });
    }
  }
  class pt extends Z {
        ...
        this.controller_.foldable
          ...
          .emitter.on("change", (t) => {
            this.emitter_.emit("fold", {
              event: new o(this, t.sender.rawValue),
            });
          }),
  ...
  class mt extends j {
    constructor(t, e) {
      super(
        Object.assign(Object.assign({}, e), {
          view: new ct(t, { viewName: "brk", viewProps: e.viewProps }),
        })
      ),
        (this.onRackAdd_ = this.onRackAdd_.bind(this)),
        (this.onRackRemove_ = this.onRackRemove_.bind(this));
    ...
    onRackAdd_(t) {
      t.isRoot && B(this.view.element, t.bladeController.view.element, t.index);
    }
    onRackRemove_(t) {
    ...
    constructor(t, e) {
      (this.className_ = v(e.viewName || "fld")),
        ...
        _(
          this.foldable_,
          "completed",
          g(this.element, this.className_(void 0, "cpl"))
        );
      const n = t.createElement("button");
      ...
      o.classList.add(this.className_("c")),
  ...
  class gt extends dt {
    constructor(t, e) {
      var n;
      const i = Q.create(null === (n = e.expanded) || void 0 === n || n),
      ...
      super(
        ...
        (this.props = e.props),
        (this.foldable = i),
        W(this.foldable, this.view.containerElement),
  ...
  const wt = {
    ...
    api: (t) =>
      t.controller instanceof gt ? new pt(t.controller, t.pool) : null,
  };
  class ft extends Y {
    constructor(t, e) {
      const n = e.valueController.viewProps;
  ...
  class yt {
    constructor(t, e) {
      ...
      n.classList.add(Ct("r")), this.element.appendChild(n);
    }
  }
  class Pt extends j {
    constructor(t, e) {
      super(
        Object.assign(Object.assign({}, e), {
          view: new yt(t, { viewProps: e.viewProps }),
        })
      );
    }
  }
  const kt = {
      ...
      type: "blade",
      accept(t) {
        const e = S(t, { view: M.required.constant("separator") });
        return e ? { params: e } : null;
      },
      controller: (t) =>
        new Pt(t.document, { blade: t.blade, viewProps: t.viewProps }),
      api: (t) => (t.controller instanceof Pt ? new xt(t.controller) : null),
    },
    Et = v("");
  function Vt(t, e) {
    return g(t, Et(void 0, e));
  }
  class Lt extends E {
    constructor(t) {
      super(t);
    ...
    bindClassModifiers(t) {
      _(this, "disabled", Vt(t, "disabled")),
        _(this, "hidden", Vt(t, "hidden"));
    }
    bindDisabled(t) {
      _(this, "disabled", (e) => {
        t.disabled = e;
  ...
  class St {
    constructor(t, e) {
      (this.element = t.createElement("div")),
        ...
        e.viewProps.bindClassModifiers(this.element),
        _(e.props, "selected", (t) => {
          t
            ? this.element.classList.add(Mt(void 0, "sel"))
            : this.element.classList.remove(Mt(void 0, "sel"));
        });
      const n = t.createElement("button");
      n.classList.add(Mt("b")),
        e.viewProps.bindDisabled(n),
        this.element.appendChild(n),
        (this.buttonElement = n);
      const i = t.createElement("div");
      i.classList.add(Mt("t")),
        w(e.props.value("title"), i),
        this.buttonElement.appendChild(i),
        (this.titleElement = i);
    }
  ...
  class At {
    constructor(t, e) {
      (this.emitter = new h()),
        ...
        (this.props = e.props),
        (this.viewProps = e.viewProps),
        (this.view = new St(t, { props: e.props, viewProps: e.viewProps })),
        this.view.buttonElement.addEventListener("click", this.onClick_);
    }
    onClick_() {
      this.emitter.emit("click", { sender: this });
  ...
  class Dt {
    constructor(t, e) {
      (this.onItemClick_ = this.onItemClick_.bind(this)),
        (this.ic_ = new At(t, { props: e.itemProps, viewProps: Lt.create() })),
        this.ic_.emitter.on("click", this.onItemClick_),
        (this.cc_ = new mt(t, { blade: X(), viewProps: Lt.create() })),
        (this.props = e.props),
        _(this.props, "selected", (t) => {
          this.itemController.props.set("selected", t),
            this.contentController.viewProps.set("hidden", !t);
        });
    }
    get itemController() {
      return this.ic_;
  ...
  class jt {
    ...
    get title() {
      var t;
      return null !==
        (t = this.controller_.itemController.props.get("title")) && void 0 !== t
        ? t
        : "";
    }
    set title(t) {
  ...
  class Rt extends Z {
    ...
    addPage(t) {
      const e = this.controller_.view.element.ownerDocument,
        n = new Dt(e, {
          itemProps: E.fromObject({ selected: !1, title: t.title }),
          props: E.fromObject({ selected: !1 }),
        });
    ...
    setUpPageApi_(t) {
      const e = this.rackApi_.apiSet_.find(
        (e) => e.controller_ === t.contentController
      );
      if (!e) throw p.shouldNeverHappen();
      const n = new jt(t, e);
  ...
  class Ot {
    constructor(t, e) {
      (this.element = t.createElement("div")),
        this.element.classList.add(Kt(), bt()),
        e.viewProps.bindClassModifiers(this.element),
        b(e.empty, g(this.element, Kt(void 0, "nop")));
      const n = t.createElement("div");
      n.classList.add(Kt("i")),
        this.element.appendChild(n),
        (this.itemsElement = n);
      const i = e.contentsElement;
      i.classList.add(Kt("c")),
        this.element.appendChild(i),
        (this.contentsElement = i);
    }
  }
  class Ut extends dt {
    constructor(t, e) {
    ...
    onPageAdd_(t) {
      const e = t.item;
      B(this.view.itemsElement, e.itemController.view.element, t.index),
    ...
    onPageSelectedChange_(t) {
      if (t.rawValue) {
        const e = this.pageSet_.items.findIndex(
          (e) => e.props.value("selected") === t.sender
        );
  ...
  const It = {
    ...
    controller(t) {
      const e = new Ut(t.document, { blade: t.blade, viewProps: t.viewProps });
      return (
        t.params.pages.forEach((n) => {
          const i = new Dt(t.document, {
            itemProps: E.fromObject({ selected: !1, title: n.title }),
            props: E.fromObject({ selected: !1 }),
          });
          e.add(i);
        }),
    ...
    api: (t) =>
      t.controller instanceof Ut ? new Rt(t.controller, t.pool) : null,
  };
  class Nt {
    constructor() {
  ...
  class zt {
    ...
    constrain(t) {
      let e = t;
      return (
        r(this.minValue) || (e = Math.max(e, this.minValue)),
        r(this.maxValue) || (e = Math.min(e, this.maxValue)),
        e
      );
    }
  }
  ...
  class Qt {
    constructor(t, e) {
      (this.element = t.createElement("div")),
        ...
        e.viewProps.bindClassModifiers(this.element),
        b(e.shows, g(this.element, Xt(void 0, "v")));
    }
  }
  class Jt {
    constructor(t, e) {
  ...
  function be(t, e) {
    return (
      (function (t, e) {
        const n = me(t, e);
        return (
          (e += n.length), "" === n ? null : { evaluable: new ie(n), cursor: e }
        );
      })(t, e) ||
      (function (t, e) {
        const n = t.substr(e, 1);
  ...
  function _e(t, e, n) {
    ...
    return i
      ? ((n += i.length), { cursor: (n += pe(e, n).length), operator: i })
      : null;
  }
  const ge = [
    ["**"],
    ...
    function t(e, n) {
      ...
      const o = t(e, n);
      return o
        ? { cursor: (n = o.cursor), evaluable: new ae(s, o.evaluable) }
        : null;
    }
  );
  function we(t, e) {
    return (e += pe(t, e).length), ge(t, e);
  }
  function fe(t) {
    var e;
    const n = (function (t) {
      const e = we(t, 0);
      return e
        ? e.cursor + pe(t, e.cursor).length !== t.length
          ? null
          : e.evaluable
        : null;
    })(t);
  ...
  function Oe(t, e) {
    ...
    return {
      x: t.pageX - (((n && n.scrollX) || 0) + i.left),
      y: t.pageY - (((n && n.scrollY) || 0) + i.top),
    };
  }
  class Ue {
    constructor(t) {
    ...
    onMouseDown_(t) {
      ...
      n.addEventListener("mousemove", this.onDocumentMouseMove_),
        ...
        this.emitter.emit("down", {
          altKey: t.altKey,
          data: this.computePosition_(Oe(t, this.elem_)),
          sender: this,
          shiftKey: t.shiftKey,
        });
    }
  ...
  class He {
    constructor(t, e) {
      (this.onChange_ = this.onChange_.bind(this)),
        ...
        e.arrayPosition &&
          this.element.classList.add(Fe(void 0, e.arrayPosition)),
        e.viewProps.bindClassModifiers(this.element);
      const n = t.createElement("input");
      n.classList.add(Fe("i")),
        (n.type = "text"),
        e.viewProps.bindDisabled(n),
        this.element.appendChild(n),
        (this.inputElement = n),
      ...
      const i = t.createElement("div");
      i.classList.add(Fe("k")),
        this.element.appendChild(i),
        (this.knobElement = i);
      const s = t.createElementNS(R, "svg");
      s.classList.add(Fe("g")), this.knobElement.appendChild(s);
      const o = t.createElementNS(R, "path");
      o.classList.add(Fe("gb")), s.appendChild(o), (this.guideBodyElem_ = o);
      const r = t.createElementNS(R, "path");
      r.classList.add(Fe("gh")), s.appendChild(r), (this.guideHeadElem_ = r);
    ...
    onDraggingChange_(t) {
      if (null === t.rawValue)
        return void this.element.classList.remove(Fe(void 0, "drg"));
  ...
  class ze {
    constructor(t, e) {
      ...
      const n = new Ue(this.view.knobElement);
    ...
    onInputKeyDown_(t) {
      const e = De(this.baseStep_, je(t));
      0 !== e &&
  ...
  class Ge {
    constructor(t, e) {
      (this.onKeyDown_ = this.onKeyDown_.bind(this)),
        ...
        (this.ptHandler_ = new Ue(this.view.trackElement)),
    ...
    onKeyDown_(t) {
      const e = De(this.baseStep_, Re(t));
      0 !== e &&
        this.value.setRawValue(this.value.rawValue + e, {
          forceEmit: !1,
          last: !1,
  ...
  function We(t) {
    ...
    return Array.isArray(t)
      ? e.required.array(
          e.required.object({ text: e.required.string, value: e.required.raw })
        )(t).value
      : "object" == typeof t
  ...
  function nn(t) {
    return r(t) ? null : new Ht(en(t));
  }
  function sn(t) {
    const e = t ? Ft(t, Ht) : null;
    return e ? e.options : null;
  }
  function on(t, e) {
    const n = t && Ft(t, $t);
    return n ? Ne(n.step) : Math.max(Ne(e), 2);
  }
  function rn(t) {
    const e = (function (t) {
      const e = t ? Ft(t, $t) : null;
  ...
  function an(t, e) {
    ...
    const i = t && Ft(t, $t),
      s = Math.abs(
        null !== (n = null == i ? void 0 : i.step) && void 0 !== n ? n : e
      );
  ...
  const cn = {
      ...
      accept: (t, e) => {
        ...
        const n = S(e, { options: M.optional.custom(We) });
      ...
      controller: (t) => {
        ...
        return s && Ft(s, Ht)
          ? new Yt(n, {
              props: E.fromObject({
                options: null !== (e = sn(s)) && void 0 !== e ? e : [],
              }),
              value: i,
              viewProps: t.viewProps,
            })
  ...
  class un {
    constructor(t, e) {
      (this.element = t.createElement("div")),
        ...
        _(e.foldable, "completed", g(this.element, hn(void 0, "cpl")));
      const n = t.createElement("div");
      ...
      const s = t.createElement("div");
      if (
        (s.classList.add(hn("t")),
        n.appendChild(s),
        (this.textElement = s),
        "inline" === e.pickerLayout)
      ) {
        const e = t.createElement("div");
        e.classList.add(hn("p")),
  ...
  const gn = {
    hsl: (t) => {
      ...
      return [
        ...
        Be(t[1], 0, 100),
        Be(t[2], 0, 100),
        Be(null !== (e = t[3]) && void 0 !== e ? e : 1, 0, 1),
      ];
    },
    hsv: (t) => {
      var e;
  ...
  class fn {
    constructor(t, e) {
      (this.mode_ = e), (this.comps_ = gn[e](t));
    }
    static black() {
      return new fn([0, 0, 0], "rgb");
    }
    static fromObject(t) {
    ...
    static isRgbColorObject(t) {
      return wn(t, "r") && wn(t, "g") && wn(t, "b");
    }
    static isRgbaColorObject(t) {
      return this.isRgbColorObject(t) && wn(t, "a");
    }
  ...
  const Ln = {
    "func.rgb": (t) => {
      ...
      if (!e) return null;
      const n = [kn(e[1], 255), kn(e[2], 255), kn(e[3], 255)];
    ...
    "func.rgba": (t) => {
      ...
      if (!e) return null;
      const n = [kn(e[1], 255), kn(e[2], 255), kn(e[3], 255), kn(e[4], 1)];
    ...
    "func.hsl": (t) => {
      ...
      if (!e) return null;
      const n = [Vn(e[1]), kn(e[2], 100), kn(e[3], 100)];
      return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2])
        ? null
        : new fn(n, "hsl");
    },
    "func.hsla": (t) => {
      ...
      if (!e) return null;
      const n = [Vn(e[1]), kn(e[2], 100), kn(e[3], 100), kn(e[4], 1)];
      return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) || isNaN(n[3])
        ? null
        : new fn(n, "hsl");
    },
      ...
      if (e)
        return new fn(
          [
            ...
            parseInt(e[2] + e[2], 16),
            parseInt(e[3] + e[3], 16),
            Ie(parseInt(e[4] + e[4], 16), 0, 255, 0, 1),
          ],
          "rgb"
        );
      const n = t.match(
  ...
  function Mn(t) {
    return Object.keys(Ln).reduce((e, n) => {
      if (e) return e;
      return (0, Ln[n])(t) ? n : null;
    }, null);
  }
  const Sn = (t) => {
    const e = Mn(t);
    return e ? Ln[e](t) : null;
  };
  function An(t) {
  ...
  function jn(t) {
    const e = Be(Math.floor(t), 0, 255).toString(16);
    return 1 === e.length ? `0${e}` : e;
  }
  function Rn(t, e = "#") {
    return `${e}${mn(t.getComponents("rgb")).map(jn).join("")}`;
  }
  function Kn(t, e = "#") {
    const n = t.getComponents("rgb");
    return `${e}${[n[0], n[1], n[2], 255 * n[3]].map(jn).join("")}`;
  }
  function On(t) {
    const e = ye(0);
  ...
  class Tn {
    constructor(t, e) {
      ...
      const n = t.createElement("div");
      n.classList.add(Bn("b")), this.element.appendChild(n);
      const i = t.createElement("div");
      i.classList.add(Bn("c")), n.appendChild(i), (this.colorElem_ = i);
      const s = t.createElement("div");
      s.classList.add(Bn("m")),
        this.element.appendChild(s),
        (this.markerElem_ = s);
      const o = t.createElement("div");
      o.classList.add(Bn("p")),
  ...
  class Fn {
    constructor(t, e) {
      (this.onKeyDown_ = this.onKeyDown_.bind(this)),
        ...
        (this.ptHandler_ = new Ue(this.view.element)),
    ...
    handlePointerEvent_(t, e) {
      ...
      this.value.setRawValue(new fn([s, o, r, n], "hsv"), e);
    }
    onPointerDown_(t) {
      this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
    }
    ...
    onKeyDown_(t) {
      const e = De(Pn(!0), Re(t));
      if (0 === e) return;
      const n = this.value.rawValue,
        [i, s, o, r] = n.getComponents("hsv");
      this.value.setRawValue(new fn([i, s, o, r + e], "hsv"), {
        forceEmit: !1,
        last: !1,
      });
    }
  ...
  class zn {
    constructor(t, e) {
      (this.element = t.createElement("div")), this.element.classList.add(Hn());
      const n = t.createElement("div");
      n.classList.add(Hn("m")),
        ...
        this.modeElem_.classList.add(Hn("ms")),
        n.appendChild(this.modeSelectElement);
      const i = t.createElement("div");
      i.classList.add(Hn("mm")),
        i.appendChild(N(t, "dropdown")),
        n.appendChild(i),
        this.element.appendChild(n);
      const s = t.createElement("div");
      s.classList.add(Hn("w")),
        this.element.appendChild(s),
        (this.textsElem_ = s),
    ...
    applyTextViews_() {
      ...
      this.textViews_.forEach((e) => {
        const n = t.createElement("div");
        n.classList.add(Hn("c")),
          n.appendChild(e.element),
          this.textsElem_.appendChild(n);
      });
    }
  }
  const $n = ye(0),
  ...
  function Gn(t, e, n) {
    return new ze(t, {
      ...
      baseStep: Pn(!1),
      parser: e.parser,
      props: E.fromObject({ draggingScale: 1, formatter: $n }),
      value: k(0, { constraint: qn[e.colorMode](n) }),
      viewProps: e.viewProps,
    });
  }
  class Yn {
      ...
      return (
        n.forEach((t, e) => {
          Ae({
            ...
            secondary: t.value,
            forward: (t) =>
              t.rawValue.getComponents(this.colorMode.rawValue)[e],
            backward: (t, n) => {
              const i = this.colorMode.rawValue,
                s = t.rawValue.getComponents(i);
              return (s[e] = n.rawValue), new fn(bn(mn(s), s[3]), i);
            },
          });
        }),
        n
  ...
  class Qn {
    constructor(t, e) {
      (this.onValueChange_ = this.onValueChange_.bind(this)),
        ...
        e.viewProps.bindTabIndex(this.element);
      const n = t.createElement("div");
      n.classList.add(Xn("c")), this.element.appendChild(n);
      const i = t.createElement("div");
      i.classList.add(Xn("m")),
        this.element.appendChild(i),
        (this.markerElem_ = i),
        this.update_();
    }
    update_() {
      ...
      this.markerElem_.style.backgroundColor = On(new fn([e, 100, 100], "hsv"));
      const n = Ie(e, 0, 360, 0, 100);
  ...
  class Jn {
    ...
    handlePointerEvent_(t, e) {
      if (!t.point) return;
      const n = Ie(t.point.x, 0, t.bounds.width, 0, 360),
        i = this.value.rawValue,
        [, s, o, r] = i.getComponents("hsv");
      this.value.setRawValue(new fn([n, s, o, r], "hsv"), e);
    }
    onPointerDown_(t) {
      this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
    }
    ...
    onKeyDown_(t) {
      const e = De(Pn(!1), Re(t));
      if (0 === e) return;
      const n = this.value.rawValue,
        [i, s, o, r] = n.getComponents("hsv");
      this.value.setRawValue(new fn([i + e, s, o, r], "hsv"), {
        forceEmit: !1,
        last: !1,
      });
    }
  ...
  class Zn {
    constructor(t, e) {
      ...
      (n.height = 64),
        (n.width = 64),
        n.classList.add(Wn("c")),
        this.element.appendChild(n),
        (this.canvasElement = n);
      const i = t.createElement("div");
      i.classList.add(Wn("m")),
        this.element.appendChild(i),
        (this.markerElem_ = i),
        this.update_();
    }
    update_() {
      ...
      const r = Ie(e[1], 0, 100, 0, 100);
      this.markerElem_.style.left = `${r}%`;
      const a = Ie(e[2], 0, 100, 100, 0);
  ...
  class ti {
    ...
    handlePointerEvent_(t, e) {
      if (!t.point) return;
      const n = Ie(t.point.x, 0, t.bounds.width, 0, 100),
        i = Ie(t.point.y, 0, t.bounds.height, 100, 0),
        [s, , , o] = this.value.rawValue.getComponents("hsv");
      this.value.setRawValue(new fn([s, n, i, o], "hsv"), e);
    }
    onPointerDown_(t) {
      this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
    }
    ...
    onKeyDown_(t) {
      Ke(t.key) && t.preventDefault();
      const [e, n, i, s] = this.value.rawValue.getComponents("hsv"),
        o = Pn(!1),
        r = De(o, Re(t)),
        a = De(o, je(t));
      (0 === r && 0 === a) ||
        this.value.setRawValue(new fn([e, n + r, i + a, s], "hsv"), {
          forceEmit: !1,
          last: !1,
        });
    }
  ...
  class ei {
    constructor(t, e) {
      (this.value = e.value),
        (this.viewProps = e.viewProps),
        (this.hPaletteC_ = new Jn(t, {
          value: this.value,
          viewProps: this.viewProps,
        })),
        (this.svPaletteC_ = new ti(t, {
          value: this.value,
          viewProps: this.viewProps,
        })),
        (this.alphaIcs_ = e.supportsAlpha
          ? {
              ...
              text: new ze(t, {
                parser: fe,
                baseStep: 0.1,
                props: E.fromObject({ draggingScale: 0.01, formatter: ye(2) }),
                value: k(0, { constraint: new zt({ min: 0, max: 1 }) }),
                viewProps: this.viewProps,
              }),
            }
          : null),
        this.alphaIcs_ &&
          Ae({
            ...
            backward: (t, e) => {
              ...
              return (n[3] = e.rawValue), new fn(n, t.rawValue.mode);
            },
          }),
        (this.textC_ = new Yn(t, {
          parser: fe,
          value: this.value,
          viewProps: this.viewProps,
        })),
  ...
  class ii {
    ...
    update_() {
      const t = this.value.rawValue;
      this.swatchElem_.style.backgroundColor = Kn(t);
    }
    onValueChange_() {
      this.update_();
    }
  ...
  class oi {
    constructor(t, e) {
      (this.onButtonBlur_ = this.onButtonBlur_.bind(this)),
        ...
        (this.value = e.value),
        (this.viewProps = e.viewProps),
        (this.foldable_ = Q.create(e.expanded)),
        (this.swatchC_ = new si(t, {
          value: this.value,
          viewProps: this.viewProps,
        }));
      ...
      n.addEventListener("blur", this.onButtonBlur_),
        ...
        (this.textC_ = new te(t, {
          parser: e.parser,
          props: E.fromObject({ formatter: e.formatter }),
          value: this.value,
          viewProps: this.viewProps,
        })),
        (this.view = new un(t, {
        ...
        (this.popC_ =
          "popup" === e.pickerLayout
            ? new Jt(t, { viewProps: this.viewProps })
            : null);
      const i = new ei(t, {
        supportsAlpha: e.supportsAlpha,
        value: this.value,
      ...
      i.view.allFocusableElements.forEach((t) => {
        ...
        this.popC_
          ...
          : this.view.pickerElement &&
            ...
            W(this.foldable_, this.view.pickerElement));
    }
    get textController() {
      return this.textC_;
    }
    ...
    onPopupChildBlur_(t) {
      ...
      const e = this.popC_.view.element,
        n = H(t);
      (n && e.contains(n)) ||
        (n && n === this.swatchC_.view.buttonElement && !O(e.ownerDocument)) ||
  ...
  function ri(t) {
    return fn.isColorObject(t) ? fn.fromObject(t) : fn.black();
  }
  function ai(t) {
    return mn(t.getComponents("rgb")).reduce(
  ...
  function pi(t) {
    return "number" != typeof t
      ? fn.black()
      : new fn([((e = t) >> 16) & 255, (e >> 8) & 255, 255 & e], "rgb");
    var e;
  }
  function di(t) {
    return "number" != typeof t
  ...
  const bi = {
      ...
      type: "input",
      accept: (t, e) => {
        if (!fn.isColorObject(t)) return null;
        const n = yn(e);
        return n ? { initialValue: t, params: n } : null;
      },
      binding: {
        ...
        equals: fn.equals,
        writer: (t) => {
          return (e = t.initialValue), fn.isRgbaColorObject(e) ? ci : hi;
          var e;
        },
      },
      controller: (t) => {
        const e = fn.isRgbaColorObject(t.initialValue),
          n = "expanded" in t.params ? t.params.expanded : void 0,
          i = "picker" in t.params ? t.params.picker : void 0,
          s = e ? Kn : Rn;
        return new oi(t.document, {
  ...
  class xi {
    constructor(t, e) {
      (this.value = e.value),
        ...
        (this.acs_ = e.axes.map((n, i) =>
          (function (t, e, n) {
            return new ze(t, {
              ...
              value: k(0, { constraint: e.axes[n].constraint }),
              viewProps: e.viewProps,
            });
          })(t, e, i)
        )),
        ...
        (this.view = new fi(t, { textViews: this.acs_.map((t) => t.view) }));
    }
  }
  function Ci(t) {
    const e = [],
      n = (function (t) {
        return "step" in t && !r(t.step) ? new $t(t.step) : null;
      })(t);
    n && e.push(n);
    const i = (function (t) {
      return ("max" in t && !r(t.max)) || ("min" in t && !r(t.min))
        ? new zt({ max: t.max, min: t.min })
        : null;
    })(t);
    i && e.push(i);
    const s = nn(t.options);
    return s && e.push(s), new Tt(e);
  }
  function yi(t) {
    const [e, n] = (function (t) {
      const e = t ? Ft(t, zt) : null;
  ...
  const Pi = {
    ...
    controller: (t) => {
      ...
      if (s && Ft(s, zt)) {
        const [e, n] = yi(s);
        return new Qe(t.document, {
          baseStep: rn(s),
          parser: fe,
          sliderProps: E.fromObject({ maxValue: n, minValue: e }),
          textProps: E.fromObject({
            draggingScale: an(s, i.rawValue),
            formatter: o,
          }),
          value: i,
          viewProps: t.viewProps,
      ...
      return new ze(t.document, {
        baseStep: rn(s),
        parser: fe,
        props: E.fromObject({ draggingScale: an(s, i.rawValue), formatter: o }),
        value: i,
        viewProps: t.viewProps,
      });
    },
  ...
  class Li {
    constructor(t, e) {
      (this.element = t.createElement("div")),
        ...
        e.viewProps.bindClassModifiers(this.element),
        b(e.expanded, g(this.element, Vi(void 0, "expanded")));
      const n = t.createElement("div");
      n.classList.add(Vi("h")), this.element.appendChild(n);
      const i = t.createElement("button");
      i.classList.add(Vi("b")),
        i.appendChild(N(t, "p2dpad")),
        e.viewProps.bindDisabled(i),
        n.appendChild(i),
        (this.buttonElement = i);
      const s = t.createElement("div");
      if (
        (s.classList.add(Vi("t")),
        n.appendChild(s),
        (this.textElement = s),
        "inline" === e.pickerLayout)
      ) {
        const e = t.createElement("div");
        e.classList.add(Vi("p")),
          this.element.appendChild(e),
          (this.pickerElement = e);
      } else this.pickerElement = null;
    }
  ...
  class Si {
    constructor(t, e) {
      ...
      const n = t.createElement("div");
      n.classList.add(Mi("p")),
        e.viewProps.bindTabIndex(n),
        this.element.appendChild(n),
        (this.padElement = n);
      const i = t.createElementNS(R, "svg");
      i.classList.add(Mi("g")),
        this.padElement.appendChild(i),
        (this.svgElem_ = i);
      const s = t.createElementNS(R, "line");
      ...
      const o = t.createElementNS(R, "line");
      ...
      const r = t.createElementNS(R, "line");
  ...
  function Ai(t, e, n) {
    return [De(e[0], Re(t)), De(e[1], je(t)) * (n ? 1 : -1)];
  }
  class Di {
    constructor(t, e) {
      (this.onPadKeyDown_ = this.onPadKeyDown_.bind(this)),
        ...
        (this.ptHandler_ = new Ue(this.view.padElement)),
        this.ptHandler_.emitter.on("down", this.onPointerDown_),
        this.ptHandler_.emitter.on("move", this.onPointerMove_),
        this.ptHandler_.emitter.on("up", this.onPointerUp_),
    ...
    handlePointerEvent_(t, e) {
      ...
      const n = this.maxValue_,
        i = Ie(t.point.x, 0, t.bounds.width, -n, +n),
        s = Ie(
      ...
      this.value.setRawValue(new ki(i, s), e);
    }
    onPointerDown_(t) {
      this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
    }
    ...
    onPadKeyDown_(t) {
      ...
      (0 === e && 0 === n) ||
        this.value.setRawValue(
          new ki(this.value.rawValue.x + e, this.value.rawValue.y + n),
          { forceEmit: !1, last: !1 }
        );
    }
    onPadKeyUp_(t) {
  ...
  class ji {
    ...
    onPopupChildBlur_(t) {
      ...
      const e = this.popC_.view.element,
        n = H(t);
      (n && e.contains(n)) ||
        (n && n === this.view.buttonElement && !O(e.ownerDocument)) ||
        (this.popC_.shows.rawValue = !1);
    }
    onPopupChildKeydown_(t) {
      this.popC_
  ...
  function Ri(t) {
    return ki.isObject(t) ? new ki(t.x, t.y) : new ki();
  }
  function Ki(t, e) {
  ...
  function Oi(t) {
    ...
    const e = [];
    return (
      r(t.step) || e.push(new $t(t.step)),
      (r(t.max) && r(t.min)) || e.push(new zt({ max: t.max, min: t.min })),
      new Tt(e)
    );
  }
  function Ui(t, e) {
  ...
  function Ii(t, e) {
    const n = e instanceof gi ? e.components[0] : void 0,
      i = e instanceof gi ? e.components[1] : void 0,
      s = Ui(n, t.x),
      o = Ui(i, t.y);
    return Math.max(s, o);
  }
  ...
  const Ti = {
      ...
      constraint: (t) => {
        return (
          ...
          new gi({
            assembly: Ei,
            components: [
              Oi("x" in e ? e.x : void 0),
              Oi("y" in e ? e.y : void 0),
            ],
          })
        );
        var e;
    ...
    controller: (t) => {
      const e = t.document,
        n = t.value,
        i = t.constraint;
      if (!(i instanceof gi)) throw p.shouldNeverHappen();
      const s = "expanded" in t.params ? t.params.expanded : void 0,
        o = "picker" in t.params ? t.params.picker : void 0;
      return new ji(e, {
        axes: [
          Ni(n.rawValue.x, i.components[0]),
          Ni(n.rawValue.y, i.components[1]),
        ],
        expanded: null != s && s,
        invertsY: Bi(t.params),
        maxValue: Ii(n.rawValue, i),
        parser: fe,
  ...
  class Fi {
    ...
    static isObject(t) {
      ...
      const e = t.x,
        ...
        i = t.z;
      return (
        "number" == typeof e && "number" == typeof n && "number" == typeof i
      );
    }
    static equals(t, e) {
  ...
  const Hi = {
    toComponents: (t) => t.getComponents(),
    fromComponents: (t) => new Fi(...t),
  };
  function zi(t) {
    return Fi.isObject(t) ? new Fi(t.x, t.y, t.z) : new Fi();
  }
  function $i(t, e) {
  ...
  const Yi = {
    ...
    type: "input",
    accept: (t, e) => {
      if (!Fi.isObject(t)) return null;
      const n = M,
        i = S(e, {
          x: n.optional.custom(tn),
          y: n.optional.custom(tn),
          z: n.optional.custom(tn),
        });
      return i ? { initialValue: t, params: i } : null;
    },
    binding: {
      ...
      constraint: (t) => {
        return (
          ...
          new gi({
            assembly: Hi,
            components: [
              qi("x" in e ? e.x : void 0),
              qi("y" in e ? e.y : void 0),
              qi("z" in e ? e.z : void 0),
            ],
          })
        );
        var e;
    ...
    controller: (t) => {
      const e = t.value,
        n = t.constraint;
      if (!(n instanceof gi)) throw p.shouldNeverHappen();
      return new xi(t.document, {
        assembly: Hi,
        axes: [
          Gi(e.rawValue.x, n.components[0]),
          Gi(e.rawValue.y, n.components[1]),
          Gi(e.rawValue.z, n.components[2]),
        ],
        parser: fe,
        value: e,
        viewProps: t.viewProps,
  ...
  const Qi = {
    toComponents: (t) => t.getComponents(),
    fromComponents: (t) => new Xi(...t),
  };
  function Ji(t) {
    return Xi.isObject(t) ? new Xi(t.x, t.y, t.z, t.w) : new Xi();
  }
  function Wi(t, e) {
    t.writeProperty("x", e.x),
      t.writeProperty("y", e.y),
  ...
  const ts = {
    ...
    type: "input",
    accept: (t, e) => {
      if (!Xi.isObject(t)) return null;
      const n = M,
        i = S(e, {
          x: n.optional.custom(tn),
          y: n.optional.custom(tn),
          z: n.optional.custom(tn),
          w: n.optional.custom(tn),
        });
      return i ? { initialValue: t, params: i } : null;
    },
    binding: {
  ...
  const es = {
      ...
      controller: (t) => {
        ...
        return s && Ft(s, Ht)
          ...
          : new te(n, {
              parser: (t) => t,
              props: E.fromObject({ formatter: Ve }),
              value: i,
              viewProps: t.viewProps,
            });
      },
  ...
  const ps = {
    ...
    accept: (t, e) => {
      if ("boolean" != typeof t) return null;
      const n = S(e, { lineCount: M.optional.number });
      return n ? { initialValue: t, params: n } : null;
    },
    binding: { reader: (t) => ee },
    controller: (t) => {
  ...
  class hs {
    constructor(t, e) {
      ...
      n.classList.add(cs("g")),
        ...
        this.element.appendChild(n),
        (this.svgElem_ = n);
      const i = t.createElementNS(R, "polyline");
    ...
    update_() {
      ...
      this.value.rawValue.forEach((o, r) => {
        if (void 0 === o) return;
        const a = Ie(r, 0, e, 0, t.width),
          l = Ie(o, n, i, t.height, 0);
        s.push([a, l].join(","));
      }),
      ...
      const a = Ie(this.cursor_.index, 0, e, 0, t.width),
        l = Ie(r, n, i, t.height, 0);
      (o.style.left = `${a}px`),
        (o.style.top = `${l}px`),
        (o.textContent = `${this.formatter_(r)}`),
        o.classList.contains(cs("t", "a")) ||
          (o.classList.add(cs("t", "a"), cs("t", "in")),
          K(o),
          o.classList.remove(cs("t", "in")));
    }
    onValueUpdate_() {
      this.update_();
    }
  ...
  class us {
    constructor(t, e) {
      if (
        ...
        const t = new Ue(this.view.element);
    ...
    onGraphMouseMove_(t) {
      ...
      this.cursor_.index = Math.floor(
        Ie(t.offsetX, 0, e.width, 0, this.value.rawValue.length)
      );
    }
  ...
  function vs(t) {
    return "format" in t && !r(t.format) ? t.format : ye(2);
  }
  function ms(t) {
              ...
              return new us(t.document, {
                ...
                maxValue:
                  ...
                  void 0 !== n
                    ...
                    : 100,
                minValue:
                  null !== (i = "min" in t.params ? t.params.min : null) &&
                  void 0 !== i
                    ? i
                    : 0,
                value: t.value,
  ...
  function fs(t, e) {
    return 0 === e ? new Nt() : new Bt(t, null != e ? e : ns.defaultInterval);
  }
  class xs {
    constructor() {
          ...
          (function (t, e) {
            ...
            const i = M,
              ...
              h = t.controller({
                ...
                params: n.params,
                value: p.value,
                viewProps: Lt.create({ disabled: d, hidden: c }),
              }),
              u = i.optional.string(e.params.label).value;
            return new nt(e.document, {
              binding: p,
              blade: X(),
              props: E.fromObject({ label: u || e.target.key }),
              valueController: h,
            });
            ...
            const l = {
              ...
              d =
                null !==
                  (i =
                    null !==
                      (n = o.optional.number(e.params.bufferSize).value) &&
                    void 0 !== n
                      ? n
                      : t.binding.defaultBufferSize &&
                        t.binding.defaultBufferSize(a.params)) && void 0 !== i
                  ? i
                  : 1,
              ...
              m = t.controller({
                ...
                params: a.params,
                value: h.value,
                viewProps: Lt.create({ disabled: u, hidden: v }),
              }),
              b =
                null !== (s = o.optional.string(e.params.label).value) &&
                void 0 !== s
                  ? s
                  : e.target.key;
            return new st(e.document, {
              binding: h,
              blade: X(),
              props: E.fromObject({ label: b }),
              valueController: m,
            });
        ...
        (n, i) =>
          ...
          (function (t, e) {
            ...
            return t.controller({
              ...
              viewProps: Lt.create({ disabled: i, hidden: s }),
            });
    ...
    createBladeApi(t) {
      ...
      const e = this.pluginsMap_.blades.reduce(
        (e, n) => e || n.api({ controller: t, pool: this }),
        null
      );
      if (!e) throw p.shouldNeverHappen();
      return e;
  ...
  const ks = {
    ...
    controller(t) {
      const e = new Yt(t.document, {
        props: E.fromObject({ options: en(t.params.options) }),
        value: k(t.params.value),
        viewProps: t.viewProps,
      });
      return new ft(t.document, {
        blade: t.blade,
        props: E.fromObject({ label: t.params.label }),
        valueController: e,
      });
    ...
    api: (t) =>
      t.controller instanceof ft && t.controller.valueController instanceof Yt
        ? new Cs(t.controller)
        : null,
  };
  class Es extends pt {
    ...
    exportPreset() {
      return (function (t) {
        return t.reduce(
          (t, e) => Object.assign(t, { [e.presetKey]: e.read() }),
          {}
        );
      })(
        this.controller_.rackController.rack
  ...
  const Ls = {
        ...
        const i = null !== (e = t.params.value) && void 0 !== e ? e : 0,
          s = new Qe(t.document, {
            ...
            textProps: E.fromObject({
              ...
              formatter:
                null !== (n = t.params.format) && void 0 !== n ? n : Ce,
            }),
            value: k(i),
            viewProps: t.viewProps,
          });
      ...
      api: (t) =>
        t.controller instanceof ft && t.controller.valueController instanceof Qe
          ? new ys(t.controller)
          : null,
    },
    Ms = {
      ...
      api: (t) =>
        t.controller instanceof ft && t.controller.valueController instanceof te
          ? new Ps(t.controller)
          : null,
    };
  function Ss(t, e, n) {
  ...
  (t.BladeApi = e),
    ...
    (t.Pane = class extends Es {
      constructor(t) {
        var e;
        const n = t || {},
          i = null !== (e = n.document) && void 0 !== e ? e : U(),
          s = (function () {
            const t = new xs();
            return (
              [
        ...
        super(
          new Vs(i, {
            expanded: n.expanded,
            blade: X(),
            props: E.fromObject({ title: n.title }),
            viewProps: Lt.create(),
          }),
          s
        ),
          ...
          (this.containerElem_ =
            ...
            (function (t) {
              const e = t.createElement("div");
              return (
                e.classList.add(v("dfw")()), t.body && t.body.appendChild(e), e
              );
            })(i)),
      ...
      embedPluginStyle_(t) {
        t.css && Ss(this.document, `plugin-${t.id}`, t.css);
      }
      setUpDefaultPlugins_() {
        Ss(
          ...
          this.registerPlugin({ plugins: [Ls, ks, It, Ms] });
      }
    }),
    (t.SeparatorApi = xt),
    (t.SliderApi = ys),
